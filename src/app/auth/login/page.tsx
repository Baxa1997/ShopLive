  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex flex-col relative">
            ...
            >
              ...
              {!magicLinkSent ? (
                <>
                  <div className="space-y-4">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white border border-slate-200 rounded-2xl font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm relative overflow-hidden group"
                    >
                      {isGoogleLoading ? (
                  ...
                  <div className="my-8 flex items-center gap-4">
                    ...
                    <span className="text-slate-400 text-xs font-bold uppercase tracking-widest">or use email</span>
                    <div className="flex-1 h-px bg-slate-200" />
                  </div>
                  ...
                  <form onSubmit={handleEmailLogin} className="space-y-5">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all font-medium"
                          required
                        />
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl font-bold transition-all shadow-lg shadow-emerald-200 disabled:opacity-70 group"
                    >
                      {isSubmitting ? (
                ...
                <motion.div
                  ...
                  className="bg-emerald-50 border border-emerald-100 p-8 rounded-[2rem] text-center"
                >
                  ...
                  <p className="text-slate-600 mb-8">
                    We've sent a magic sign-in link to <span className="font-bold text-emerald-700">{email}</span>.
                  </p>
                  <button
              ...
              <p className="mt-10 text-center text-xs text-slate-400 leading-relaxed">
                ...
                <Link href="/policy" className="underline hover:text-slate-600 transition-colors">Terms of Service</Link>{' '}
                and{' '}
                <Link href="/policy" className="underline hover:text-slate-600 transition-colors">Privacy Policy</Link>.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="p-8 mt-auto flex items-center justify-center gap-8 border-t border-slate-100">
          <div className="flex items-center gap-2 grayscale opacity-50">
            <Globe className="w-4 h-4" />
            <span className="text-xs font-bold text-slate-900 tracking-tight">Worldwide</span>
          </div>
          <div className="flex items-center gap-2 grayscale opacity-50">
            <ShieldCheck className="w-4 h-4" />
            <span className="text-xs font-bold text-slate-900 tracking-tight">Enterprise Ready</span>
          </div>
        </div>
      </div>
    </div>
