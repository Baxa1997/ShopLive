              ...
              <>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-xl font-medium transition-all disabled:opacity-70 disabled:cursor-not-allowed relative overflow-hidden shadow-sm"
                  >
                    <AnimatePresence>
                      {isSigningIn && (
                        <motion.div
